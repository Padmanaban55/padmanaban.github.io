...
<div class='webex-radiogroup' id='radio_PFIFYQRENW'><label><input type="radio" autocomplete="off" name="radio_PFIFYQRENW" value=""></input> <span>Type 1 Diabetes mellitus</span></label><label><input type="radio" autocomplete="off" name="radio_PFIFYQRENW" value="answer"></input> <span>Type 1 Diabetes mellitus</span></label><label><input type="radio" autocomplete="off" name="radio_PFIFYQRENW" value=""></input> <span>MODY</span></label><label><input type="radio" autocomplete="off" name="radio_PFIFYQRENW" value=""></input> <span>GDM</span></label></div>
...
<div class='webex-radiogroup' id='radio_GOKYFOGODF'><label><input type="radio" autocomplete="off" name="radio_GOKYFOGODF" value=""></input> <span>Only insulin deficiency</span></label><label><input type="radio" autocomplete="off" name="radio_GOKYFOGODF" value=""></input> <span>Only insulin resistance</span></label><label><input type="radio" autocomplete="off" name="radio_GOKYFOGODF" value="answer"></input> <span>Combination of insulin deficiency and insulin resistance</span></label></div>
