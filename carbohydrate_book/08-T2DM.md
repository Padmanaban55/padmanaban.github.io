...
<div class='webex-radiogroup' id='radio_VEDIOFRGXK'><label><input type="radio" autocomplete="off" name="radio_VEDIOFRGXK" value=""></input> <span>Type 1 Diabetes mellitus</span></label><label><input type="radio" autocomplete="off" name="radio_VEDIOFRGXK" value="answer"></input> <span>Type 1 Diabetes mellitus</span></label><label><input type="radio" autocomplete="off" name="radio_VEDIOFRGXK" value=""></input> <span>MODY</span></label><label><input type="radio" autocomplete="off" name="radio_VEDIOFRGXK" value=""></input> <span>GDM</span></label></div>
...
<div class='webex-radiogroup' id='radio_ICMCEGSPSY'><label><input type="radio" autocomplete="off" name="radio_ICMCEGSPSY" value=""></input> <span>Only insulin deficiency</span></label><label><input type="radio" autocomplete="off" name="radio_ICMCEGSPSY" value=""></input> <span>Only insulin resistance</span></label><label><input type="radio" autocomplete="off" name="radio_ICMCEGSPSY" value="answer"></input> <span>Combination of insulin deficiency and insulin resistance</span></label></div>
