...
<div class='webex-radiogroup' id='radio_GEQDVSLPEZ'><label><input type="radio" autocomplete="off" name="radio_GEQDVSLPEZ" value=""></input> <span>Type 1 Diabetes mellitus</span></label><label><input type="radio" autocomplete="off" name="radio_GEQDVSLPEZ" value="answer"></input> <span>Type 1 Diabetes mellitus</span></label><label><input type="radio" autocomplete="off" name="radio_GEQDVSLPEZ" value=""></input> <span>MODY</span></label><label><input type="radio" autocomplete="off" name="radio_GEQDVSLPEZ" value=""></input> <span>GDM</span></label></div>
...
<div class='webex-radiogroup' id='radio_NFQDAGCEPM'><label><input type="radio" autocomplete="off" name="radio_NFQDAGCEPM" value=""></input> <span>Only insulin deficiency</span></label><label><input type="radio" autocomplete="off" name="radio_NFQDAGCEPM" value=""></input> <span>Only insulin resistance</span></label><label><input type="radio" autocomplete="off" name="radio_NFQDAGCEPM" value="answer"></input> <span>Combination of insulin deficiency and insulin resistance</span></label></div>
